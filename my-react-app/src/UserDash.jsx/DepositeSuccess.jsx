            ...
            <CardBody style={{ background: "#f9f9f9", padding: "30px" }}>
              {response ? (
                <div style={{ textAlign: "center" }}>
                  ...
                  >
                    <p>
                      <strong>Available Balance:</strong> ₹{response[1]}
                    </p>
                    <p>
                      <strong>Account Type:</strong>{" "}
                      <span style={{ color: "#1c92d2", fontWeight: "bold" }}>{response[2]}</span>
                    </p>
                    <p>
                      <strong>User Name:</strong> {response[1]}
                    </p>
                  </div>
                  <Button
                    color="primary"
